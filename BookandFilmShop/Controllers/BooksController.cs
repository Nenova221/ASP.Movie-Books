...
namespace BookandFilmShop.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(BookandFilmShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Book != null ? 
                          ...
                          Problem("Entity set 'BookandFilmShopContext.Book'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookandFilmShopContext.Book'  is null.");
            }
            var book = await _context.Book.FindAsync(id);
            if (book != null)
            {
